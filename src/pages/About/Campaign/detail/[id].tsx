            ...
            <div className="leadership-detail campaign-detail">
                <div className="container">
                    <div className="card rounded-0">
                        <img src="/img/illustrative_campaign_1.png" className="card-img-top rounded-0 d-md-none mb-0" alt="..." />

                        <div className="card-body">

                            <div className="d-flex align-items-start">
                                <img src="/img/illustrative_campaign_1.png" className="img-big d-none d-xl-block" alt="..." />
                                <div className="content flex-grow-1">

                                    <div className="row align-items-end">
                                        <div className="col-12 col-md-6 d-none d-md-block d-xl-none">
                                            <img src="/img/illustrative_campaign_1.png" className="img-fluid" alt="..." />
                                        </div>
                                    ...
                                    <div className="campaign-detail-button text-center d-flex justify-content-center justify-content-md-start py-5 pt-md-4 pb-md-3 pt-xl-5 pb-xl-5 mt-xl-5">
                                        <a href="subscribe-volunteer.html" className="btn btn-primary">Join Campaign</a>
                                    </div>
