        ...
        <>
            ...
            <div className="login login-demo-user d-flex justify-content-center">
                <div className="row  w-100">
                                ...
                                <div className="card border-0">
                                    <div className="card-body">
                                        ...
                                        <div className="card-text subscribe-card-text">
                                            Please complete the form to proceed your registration and enjoy your Gyloop Demo
                                        </div>
                    ...
                    <div className="col-xl-6 d-none d-xl-block side-info subscribe-demo-user px-xl-0">
                        <div className="wrapper2 d-flex align-items-end h-100">

                            <div className="subscribe-demo-user-subheader px-5 py-3 text-white">
                                <div className="row">
                                    <div className="col-xl-9">
                                        <i className="fas fa-rocket-launch fa-3x"></i>
                                        <p className="subscribe-demo-user-title">DEMO SYSTEM</p>
