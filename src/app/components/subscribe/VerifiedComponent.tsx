        ...
        <>
            ...
            <div className="login login-demo-user subscribe-verified d-flex justify-content-center">
                ...
                <div className="row  w-100">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <form className="gyloop-form" onSubmit={onSubmit}>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control input-label"
                                                    {...register("networkReference")} disabled={true} />
                                                <small className="label-error">{errors.networkReference?.message}</small>
                                            </div>
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="gyloop-select">
                                                    <select className="form-control input-label" disabled {...register("mainRole")}>
                                                ...
                                                <small className="label-error">{errors.mainRole?.message}</small>
                                            </div>
                                        ...
                                        <footer className="d-xl-none">
                                            <p className="text-center">
                                                &copy; 3 Gyloop. All rights reserved.
                                            </p>
                                        </footer>
                    ...
                    <div className="col-xl-6 d-none d-xl-block side-info subscribe-demo-user subscribe-verified-bg px-xl-0 h-100">
