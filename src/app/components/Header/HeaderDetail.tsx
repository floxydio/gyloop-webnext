        ...
        <>
            ...
            <nav className="navbar navbar-expand-xl navbar-dark bg-primary">
                <div className="container align-items-center">
                    <Link className="navbar-brand d-flex mr-5" href={`/${contextLocale ?? router.defaultLocale}`}>
                        <Image
                            priority
                    ...
                    <div className="collapse navbar-collapse" id="navbarColor02">
                        <ul className="nav-search-off navbar-nav mr-auto">
                            ...
                            >
                                ...
                                >
                                    <Link className="dropdown-item" href={`/${contextLocale}/product-business`} >
                                        <Image
                                    ...
                                    <Link className="dropdown-item" href={`/${contextLocale}/product-network`}>
                                        <Image
                                    ...
                                    <Link className="dropdown-item" href={`/${contextLocale}/product-connector`}>
                                        <Image
                                    ...
                                    <Link className="dropdown-item" href={`/${contextLocale}/product-provider`}>
                                        <Image
                            ...
                            >
                                ...
                                >
                                    <Link
                                        ...
                                        href={`/${contextLocale}/solution-salesautomation`}
                                    >
                                        <span>Sales Automation</span>
                                    </Link>
                                    <Link
                                        className="dropdown-item"
                                        href={`/${contextLocale}/solution-catalogmanagement`}
                                    >
                                        <span>Catalog Management</span>
                                    </Link>
                                    <Link
                                        className="dropdown-item"
                                        href={`/${contextLocale}/solution-sourcingmanagement`}
                                    >
                                        <span>Sourcing Management</span>
                                    </Link>
                                    <Link
                                        className="dropdown-item"
                                        href={`/${contextLocale}/solution-eprocurement`}
                                    >
                                        <span>E-Procurement</span>
                                    </Link>
                                    <Link
                                        className="dropdown-item"
                                        href={`/${contextLocale}/solution-customerportal`}
                                    >
                                        <span>Customer Portal</span>
                                    </Link>
                                    <Link
                                        className="dropdown-item"
                                        href={`/${contextLocale}/solution-vendorportal`}
                                    >
                                        <span>Vendor Portal</span>
                                    </Link>
                                    <Link
                                        className="dropdown-item"
                                        href={`/${contextLocale}/solution-billingautomation`}
                                    >
                                        <span>Billing Automation</span>
                                    </Link>
                                    <Link
                                        className="dropdown-item"
                                        href={`/${contextLocale}/solution-invoiceautomation`}
                                    >
                                        <span>Invoice Automation</span>
                                    </Link>
                                    <Link
                                        className="dropdown-item"
                                        href={`/${contextLocale}/solution-businessnetworking`}
                                    >
                                        <span>Business Networking</span>
                                    </Link>
                                    <Link
                                        className="dropdown-item"
                                        href={`/${contextLocale}/solution-serviceprovider`}
                                    >
                            ...
                            >
                                ...
                                <div
                                    ...
                                    aria-labelledby="navbarDropdown"
                                >
                                    <Link className="dropdown-item" href={`/${contextLocale}/resource-library`}>
                                        <span>Library</span>
                                    </Link>
                                    <Link className="dropdown-item" href={`/${contextLocale}/resource-livedemo`}>
                                        <span>System Demo</span>
                                    </Link>
                                    <Link className="dropdown-item" href={`/${contextLocale}/resource-blog`}>
                                        <span>Blogs</span>
                                    </Link>
                                </div>
                            </li>
                            ...
                            >
                                ...
                                <div
                                    ...
                                    aria-labelledby="navbarDropdown"
                                >
                                    <Link className="dropdown-item" href={`/${contextLocale}/about-leadership`}>
                                        <span>Gyloop Leadership</span>
                                    </Link>
                                    <Link className="dropdown-item" href={`/${contextLocale}/about-newsevent`}>
                                        <span>News and Events</span>
                                    </Link>
                                    <Link className="dropdown-item" href={`/${contextLocale}/about-campaign`}>
                                        <span>Gyloop Campaign</span>
                                    </Link>
                                    <Link className="dropdown-item" href={`/${contextLocale}/about-culture`}>
