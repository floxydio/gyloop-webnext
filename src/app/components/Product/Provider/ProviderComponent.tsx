...
import BusinessTabThree from "../Business/BusinessTabThree"
...
export default function ProviderComponent() {
    ...
    return (
        <>
            ...
            <div className="subheader-bg-cover billing-automation-subheader provider-subheader">
                ...
                <div className="container">
                    <ul className="nav nav-tabs">
                        <li className="nav-item">
                            <a className="nav-link" href="#business-collapse-1" data-toggle="collapse" aria-expanded="true">
                                <i className="fas fa-heart mr-2"></i>
                                CRM Module
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#business-collapse-2" data-toggle="collapse">
                                <i className="fas fa-shopping-cart mr-2"></i>
                                SRM Module
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#business-collapse-3" data-toggle="collapse">
                ...
                <div className="container">
                    ...
                    <div>
                        <h4 className="footer-links-toggle d-flex align-items-center d-xl-none" data-toggle="collapse"
                            data-target="#business-collapse-1" aria-expanded="true">
                            <i className="fas fa-heart"></i>
                            <span className="ml-2 mr-auto">CRM Module</span>

                            <i className="fas fa-angle-down icon-rotates"></i>
                        </h4>
                        <div id="business-collapse-1" className="collapse show" data-parent="#business-accordion">
                            <div className="tab">
                                <BusinessTab />
                    ...
                    <div>
                        ...
                        <div id="business-collapse-2" className="collapse" data-parent="#business-accordion">
                            <div className="tab">
                                <BusinessTabTwo />
                    ...
                    <div>
                        ...
                        <div id="business-collapse-3" className="collapse" data-parent="#business-accordion">
                            <div className="tab">
                                <BusinessTabThree />
            ...
            <div className="business-feature provider-feature">
                <div className="container">
                    <div className="content">
                        ...
                        <p className="text">
                            Gyloop has been developed by customer experiences, and br/ing customer value on top of application
                        ...
                        <p className="text">
                            ...
                            business
                            application to robust your business processes.
                        </p>
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-3 px-md-1 px-xl-2">
                            <div className="card border-0 rounded-0">
                                ...
                                <div className="card-footer">
                                    <a href="subscribe-professional.html" className="btn btn-primary btn-block gyloop-btn">
                                        Register Now
                                    </a>
                                </div>
                            </div>
                ...
                <div className="container">
                    ...
                    <div className="card rounded-0">
                        <div className="card-header">
                            <h4 className="card-title d-flex align-items-start mb-0" data-toggle="collapse" data-target="#faq-1"
                                aria-expanded="true">
                        ...
                        <div className="collapse show" id="faq-1" data-parent="#faq-accordion">
                            <div className="card-body">
                                <div className="card-text">
                                    <p>
                                        No, you can’t access the Gyloop Networks Apps with Verified User, you need to upgrade your User to enjoy more
                                        feature of Gyloop Business and get the access to Gyloop Networks.
                                    </p>
                                ...
                                <a href="business.html?s=business-pricing" className="gyloop-link d-block">
                                    Learn More User Comparison
                                    <i className="fas fa-angle-right"></i>
                                </a>
                                <a href="subscribe-professional.html" className="gyloop-link d-block">
                                    Upgrade User
                                    <i className="fas fa-angle-right"></i>
                                </a>
                            </div>
                    ...
                    <div className="card rounded-0">
                        <div className="card-header">
                            <h4 className="card-title d-flex align-items-start mb-0" data-toggle="collapse" data-target="#faq-2"
                                aria-expanded="false">
                                <i className="far fa-plus-circle"></i>
                                <i className="far fa-minus-circle"></i>
                                <span>
                    ...
                    <div className="card rounded-0">
                        <div className="card-header">
                            <h4 className="card-title d-flex align-items-start mb-0" data-toggle="collapse" data-target="#faq-3"
                                aria-expanded="false">
                                <i className="far fa-plus-circle"></i>
                                <i className="far fa-minus-circle"></i>
                                <span>
                    ...
                    <div className="card rounded-0">
                        <div className="card-header">
                            <h4 className="card-title d-flex align-items-start mb-0" data-toggle="collapse" data-target="#faq-4"
                                aria-expanded="false">
                                <i className="far fa-plus-circle"></i>
                                <i className="far fa-minus-circle"></i>
                                <span>
                    ...
                    <div className="card rounded-0">
                        <div className="card-header">
                            <h4 className="card-title d-flex align-items-start mb-0" data-toggle="collapse" data-target="#faq-5"
                                aria-expanded="false">
                                <i className="far fa-plus-circle"></i>
                                <i className="far fa-minus-circle"></i>
                                <span>
                    ...
                    <div className="card rounded-0">
                        <div className="card-header">
                            <h4 className="card-title d-flex align-items-start mb-0" data-toggle="collapse" data-target="#faq-6"
                                aria-expanded="false">
                                <i className="far fa-plus-circle"></i>
                                <i className="far fa-minus-circle"></i>
                                <span>
            ...
            <div className="footer-bg-cover billing-automation-footer business-footer provider-footer">
                <div className="container justify-content-md-start">
                    <div className="content">
                        ...
                        <div className="d-flex justify-content-center justify-content-md-start">
                            <a href="live-demo.html" className="btn btn-primary gyloop-btn mr-2 mr-xl-4">System Demo</a>
