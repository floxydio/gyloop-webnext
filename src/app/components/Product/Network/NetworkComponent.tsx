                                    ...
                                    <div className="row">
                                        <div className="col-8 col-md-12">
                                            <h5 className="card-title">
                                                <div>
                                                    <img className="logo-price mr-0" src="/img/icon_bagde_volunteer.png" alt="" />
                                                    <img className="logo-price mr-0" src="/img/icon_bagde_functional.png" alt="" />
                                    ...
                                    <div className="row">
                                        <div className="col-12 col-md-12">
                                            ...
                                            <p className="card-text card-text-lg mb-2">
                                                Connect with trusted and qualified supplier and buyers across industry and
                                                locations.
                                            </p>
                                            <p className="card-text card-text-lg mb-2">
                                                Discover the full features of Gyloop Networks for free of subscription cost
                                                using your existing Gyloop Business User*.
                                            </p>
