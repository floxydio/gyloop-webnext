                    ...
                    <div className="row">
                        <div className="col-xl-6 d-none d-xl-block">
                            ...
                            <div className="position-absolute logo-top">
                                <a href="index.html">
                                    <img src="/img/logo-gyloop-dark.png" alt="Logo Gyloop"/>
                                </a>
                            </div>
                            ...
                            <div className="card border-0 rounded-0">
                                <div className="card-body">
                                    ...
                                    <div className="card-text">
                                        <p>Please simply fill out the question form and we will get in touch with you shortly
                                        </p>
                                    </div>

                                    <form className="gyloop-form" method="POST" encType="multipart/form-data">
                                        ...
                                        <div className="form-group">
                                            <textarea className="form-control input-label" value="Message or comments"
                                                rows={3}></textarea>
                                            <small className="label-error">Error Message.</small>
                                        </div>
                                        ...
                                        <div className="form-group mt-2" id="input-file-container">
                                            <div className="d-flex">
                                                <label className="label mr-auto" htmlFor="customFile">Attachment File Name</label>
                                        ...
                                        <button type="submit" className="btn btn-primary btn-block gyloop-btn">Send Message</button>
                                        <div>&nbsp;</div>
