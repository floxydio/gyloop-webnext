                ...
                <div className="card border-0">
                  <div className="card-body">
                    <Image
                      ...
                      height={0}
                      sizes="100"
                      alt="gyloop-icon-badge-funcitional"
                    />

                    <Link href="/">
                      <Image
                        className="logo-gyloop card-title ml-0"
              ...
              <div className="subscribe-demo-user-subheader px-5 py-3 text-white">
                <div className="row">
                  <div className="col-xl-9">
                    <Image
                      src="/img/icon_bagde_functional_white.png"
                    ...
                    <div className="subscribe-demo-user-subtitle">
                      ...
                      better built by strong relationships. Business entities
                      are now easy to connect to the unlimited networks across
