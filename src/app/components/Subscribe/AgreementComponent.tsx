            ...
            <div className="mb-5">
                <div className="container privacy-container py-3 pb-md-2 py-xl-4">
                    ...
                    <div className="privacy-content">
                        ...
                        <p>
                            Who is the Data Controller? The data controller of www.ariba.com is Ariba Inc., 3420 Hillview Ave, Palo Alto, CA 94304, USA (“SAP Ariba”). The SAP Group’s data protection officer can be reached at privacy@sap.com.
                        </p>
                        <br />
                        <p>
                        ...
                        <br />
                        <p>
                            Processing when necessary to fulfill SAP Ariba’s contractual obligation includes responding to your related inquiries and providing you with shipping and billing information and to processing your feedback or to provide You with access to the SAP Ariba customer support systems, provide support services to You and enable You to download content from the SAP Ariba customer support systems. This may also include conversation data that you may trigger via the chat functionalities on SAP Ariba.com or other local SAP Ariba web presences, contact forms, emails, or telephone. In this Privacy Policy, “goods and services” includes (access to) SAP Ariba’s web services, offerings, contests, sweepstakes, other content, customer support services, non-marketing related newsletters, whitepapers, tutorials, trainings and events.
                        </p>
                    </div>
                </div>
            </div>
