                    ...
                    <form className="gyloop-form" onSubmit={onSubmit}>
                      ...
                      <div className="form-group">
                        <label className="label">
                          Company Name
                          <i className="fas fa-question-circle ml-2" data-toggle="tooltip"
                      ...
                      <div className="custom-control custom-checkbox my-0">
                        <input type="checkbox" className="custom-control-input" id="trial"  {...register("trial")} />
                        <label className="custom-control-label" htmlFor="trial">Trial 30 Days <i
                          className="fas fa-question-circle ml-2" data-toggle="tooltip"
                          title="Tooltip Content"></i>
                        </label>
                      </div>
