        ...
        <div className="container">
            <div className="row">
                <div className="col-12 col-md-8 pr-md-0 pr-xl-4">
                    <h5 className="title">Gyloop Business New Features Released Q4 2020</h5>
                    <p className="subtitle">Highlight News</p>
                    <p className="meta-date">12 July 2020</p>

                    <div className="social-links">
                        <a href="https://twitter.com" target="_blank" className="text-blue">
                        ...
                        <a href="https://facebook.com" target="_blank" className="text-blue">
                            <span className="fa-stack" style={{
                                verticalAlign:"top"
                            }}>
                                <i className="fal fa-circle fa-stack-2x"></i>
                        ...
                        <a href="https://linkedin.com" target="_blank" className="text-blue">
                            <span className="fa-stack" style={{
                                verticalAlign:"top"
                            }}>
                                <i className="fal fa-circle fa-stack-2x"></i>
                    ...
                    <div className="card border-0 rounded-0 mt-3">
                        <img src="/img/image_placeholder.png" className="card-img-top rounded-0" alt="..." />
                ...
                <div className="col-12 col-md-4">
                    ...
                    <div className="card card-featured border-0 rounded-0">
                        <img src="/img/image_placeholder.png" className="card-img-top img-fluid rounded-0" alt="..."/>
                        ...
                        <div className="card-body">
                            ...
                            <a href="news-and-event-detail.html" className="text-blue d-none d-md-block">
                                Learn More
                    ...
                    <div className="card card-featured border-0 rounded-0">
                        <img src="/img/image_placeholder.png" className="card-img-top img-fluid" alt="..."/>
