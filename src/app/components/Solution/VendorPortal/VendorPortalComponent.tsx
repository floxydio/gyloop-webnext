...
<header className="header-bg-cover billing-automation-header d-flex align-items-end vendor-portal-header">
    ...
    <div className="subheader-bg-cover billing-automation-subheader vendor-portal-subheader">
        <div className="container">
        ...
        <div className="container">
            <div className="content">
                ...
                <div className="d-flex justify-content-center justify-content-md-start">
                    <a href="libr/ary.html" className="btn btn-primary gyloop-btn mr-2 mr-xl-4">Documentation</a>
