...
export default function EProcurementComponent({
  ...
  return (
    <>
      ...
      {dataSolutionFunction.map((data) => {
        return (
          <>
            {data.submit_type === 1 ? (
              <div
                className="subheader-bg-cover billing-automation-subheader e-procurement-subheader"
                key={data.id}
              >
                <div className="container">
      ...
      <BillingProcurement dataSolutionProduct={dataSolutionProduct} />
