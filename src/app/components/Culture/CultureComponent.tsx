                ...
                <div className="container">
                    <div className="card border-0 rounded-0 bg-transparent">
                        <div className="card-body">
                            ...
                            <img src="/img/background_culture_profile_website.png" className="bonafide-image img-fluid d-block mx-auto" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    ...
                    <div className="card border-0 rounded-0">
                        <div className="row">
                            <div className="col-12 col-md-6 pr-md-0">
                                <img src="/img/illustrative_culture_1.png" className="features-image img-fluid" />
                            </div>
                    ...
                    <div className="card border-0 rounded-0">
                        <div className="row">
                            ...
                            <div className="col-12 col-md-6 pl-md-0">
                                <img src="/img/illustrative_culture_2.png" className="features-image img-fluid" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card border-0 rounded-0">
                        <div className="row">
                            <div className="col-12 col-md-6 pr-md-0">
                                <img src="/img/illustrative_culture_3.png" className="features-image img-fluid" />
                            </div>
                ...
                <div className="container justify-content-md-start">
                    <div className="content">
                        ...
                        <div className="d-flex justify-content-center justify-content-md-start">
                            <a href="leadership.html" className="btn btn-primary gyloop-btn mr-2 mr-xl-4">Career</a>
